...
export type waitForResponse = ReturnType<Page['waitForResponse']>;
export type waitForRequest = ReturnType<Page['waitForRequest']>;
export type KeyboardPressOptions = Parameters<Page['keyboard']['press']>[1];
